...
data {
  ...
  real log_ave_mean;       // mean for prior on log_average parameter
  real log_ave_sd;         // standard deviation for prior on log_average parameter
  real log_dif_mean;       // mean for prior on log_difference parameter
  real log_dif_sd;         // standard deviation for prior on log_difference parameter
...
parameters {
  // average of log alpha and log_scaled_beta for gamma distribution
  real<lower=log_ave_mean-6*log_ave_sd , upper=log_ave_mean+6*log_ave_sd> log_average;
  
  // 1/2 difference between log alpha and log_scaled_beta for gamma distribution
  real<lower=log_dif_mean-6*log_dif_sd , upper=log_dif_mean+6*log_dif_sd> log_difference;
...
model {
  log_difference ~ normal(log_dif_mean, log_dif_sd);
  log_average ~ normal(log_ave_mean, log_ave_sd);
